...
namespace WordPressMeetupsWidget\WordPress;
...
class Widget extends WP_Widget
{
    ...
    public function __construct($widgetSlug)
    {
        ...
        parent::__construct(
            $this->getWidgetSlug(),
            __('Wordpress Meetups', $this->getWidgetSlug()),
            [
                'classname' => $this->getWidgetSlug().'-class',
                'description' => __('Display a list of official WordPress Meetups.', $this->getWidgetSlug()),
            ]
        );
    }
